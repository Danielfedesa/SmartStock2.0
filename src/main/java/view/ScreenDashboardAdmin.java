...
public class ScreenDashboardAdmin extends JFrame {
    ...
    public ScreenDashboardAdmin() {
        ...
        JPanel movInventario = createImageButton("movimientos.png", "Movimientos de Inventario", this::abrirMovInventario, 40, 40);
        JPanel copiasSeguridad = createImageButton("copias.png", "Copias de Seguridad", this::abrirCopiasSeguridad, 40, 40);
